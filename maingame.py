...
blinky_img = pygame.transform.scale(pygame.image.load(f'resources/images/ghosts/red.png'), (45,45))
inky_img = pygame.transform.scale(pygame.image.load(f'resources/images/ghosts/blue1.png'), (45,45))
pinky_img = pygame.transform.scale(pygame.image.load(f'resources/images/ghosts/pink.png'), (45,45))
